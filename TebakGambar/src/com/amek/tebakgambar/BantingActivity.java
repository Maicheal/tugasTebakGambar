...
public class BantingActivity extends Activity {
	EditText jawabantxt;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_banting);
	...
	public void cek(View v){
    	String jawabanBenar = "BANTING TULANG";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.banting, menu);
		return true;
	}
